 ...
 *          Register
 ***************************************************************************/
PUBLIC void register_yuno_yuneta_agent(void)
{
    GCLASS *gclass;
     ...
     */
    gclass = gobj_subclass_gclass(gclass_default_yuno(), GCLASS_YUNETA_AGENT_NAME);
    ...
    gobj_register_yuno(ROLE_YUNETA_AGENT, gclass, TRUE);
}
